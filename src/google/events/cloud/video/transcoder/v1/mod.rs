...
pub struct Job {
    ...
    #[prost(oneof = "job::JobConfig", tags = "5")]
...
pub struct EditAtom {
    ...
    /// the end of the atom.
    #[prost(message, optional, tag = "3")]
    pub end_time_offset: ::core::option::Option<::pbjson_types::Duration>,
    /// Start time in seconds for the atom, relative to the input file timeline.
    /// The default is `0s`.
    #[prost(message, optional, tag = "4")]
    pub start_time_offset: ::core::option::Option<::pbjson_types::Duration>,
}
/// Ad break.
#[derive(serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
...
pub mod sprite_sheet {
    ...
    pub enum ExtractionStrategy {
        ...
        Interval(::pbjson_types::Duration),
    }
}
...
pub mod video_stream {
    ...
    pub mod h264_codec_settings {
        ...
        pub enum GopMode {
            ...
            /// `gopDuration`.
            #[prost(message, tag = "10")]
            GopDuration(::pbjson_types::Duration),
        }
    }
    /// H265 codec settings.
    #[derive(serde::Serialize, serde::Deserialize)]
...
pub struct SegmentSettings {
    ...
    #[prost(message, optional, tag = "1")]
    pub segment_duration: ::core::option::Option<::pbjson_types::Duration>,
...
#[serde(rename_all = "snake_case")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct JobTemplateEventData {
    /// Optional. The JobTemplate event payload. Unset for deletion events.
    #[prost(message, optional, tag = "1")]
    pub payload: ::core::option::Option<JobTemplate>,
}
...
#[serde(rename_all = "snake_case")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct JobTemplateCreatedEvent {
    /// The data associated with the event.
    #[prost(message, optional, tag = "1")]
    pub data: ::core::option::Option<JobTemplateEventData>,
}
/// The CloudEvent raised when a JobTemplate is deleted.
#[derive(serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct JobTemplateDeletedEvent {
    /// The data associated with the event.
    #[prost(message, optional, tag = "1")]
    pub data: ::core::option::Option<JobTemplateEventData>,
}
